...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">اراء العملاء</h3>
      <a href="{{ route('admin-feedback.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
                ...
                data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td><img src="{{ asset('uploads/feedbacks') }}/{{ $row->image }}" width="100" height="100"> </td>
                                      <td>
                                        <div class="btn-group">
