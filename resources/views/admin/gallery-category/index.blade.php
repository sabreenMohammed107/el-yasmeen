...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">تصنيف الصور العمل</h3>
      <a href="{{ route('admin-gallery-category.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
            ...
            @foreach($rows as $index => $row)
                <tr>
                    ...
                    <td>{{$row->name}}</td>
                          ...
                          <td>
                            <div class="btn-group">
                                ...
                                <a href="{{ route('admin-gallery-category.edit', $row->id) }}">
                 ...
                 <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                    ...
                    <form action="{{ route('admin-gallery-category.destroy', $row->id) }}"  method="POST" >
                        @csrf
                        @method('DELETE')
