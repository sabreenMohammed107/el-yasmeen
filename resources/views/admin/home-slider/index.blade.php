...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            ...
            <a href="{{ route('home-slider.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
                    ...
                    <tbody>
                        @foreach ($rows as $index => $row)
                            <tr>
                                ...
                                <td>{!! $row->text !!} </td>
                                <td><img src="{{ asset('uploads/sliders') }}/{{ $row->image }}" width="100" height="100"></td>


                                <td>
                                    <div class="btn-group">

                                            <a href="{{ route('home-slider.edit', $row->id) }}">
                            ...
                            <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <form action="{{ route('home-slider.destroy', $row->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
